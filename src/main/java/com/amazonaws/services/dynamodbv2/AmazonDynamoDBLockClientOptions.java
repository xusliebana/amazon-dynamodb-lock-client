...
public class AmazonDynamoDBLockClientOptions {
    ...
    public static class AmazonDynamoDBLockClientOptionsBuilder {
        ...
        AmazonDynamoDBLockClientOptionsBuilder(final AmazonDynamoDBClient dynamoDBClient, final String tableName) {
        ...
        AmazonDynamoDBLockClientOptionsBuilder(final AmazonDynamoDBClient dynamoDBClient, final String tableName, final String ownerName,
     ...
     */
    public static AmazonDynamoDBLockClientOptionsBuilder builder(final AmazonDynamoDBClient dynamoDBClient, final String tableName) {
        return new AmazonDynamoDBLockClientOptionsBuilder(dynamoDBClient, tableName);
    }

    private AmazonDynamoDBLockClientOptions(final AmazonDynamoDBClient dynamoDBClient, final String tableName, final String partitionKeyName, final Optional<String> sortKeyName,
